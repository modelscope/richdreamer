...
wget https://virutalbuy-public.oss-cn-hangzhou.aliyuncs.com/share/RichDreamer/models_sd.tar.gz -O pretrained_models/models_sd.tar.gz
mv pretrained_models/models_sd.tar.gz pretrained_models/huggingface/hub/
cd pretrained_models/huggingface/hub/
tar -xvf models_sd.tar.gz ./